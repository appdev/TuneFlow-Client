...
void main() {
  ...
  test(
    ...
    () async {
      ...
      await controller.setShowTranslation(false);
      await controller.setShowRomanization(true);
      await controller.setLyricFontSize(LyricFontSize.large);
      await controller.setLyricAlignment(LyricAlignment.center);
      await controller.setLyricAuxiliaryOrder(
        LyricAuxiliaryOrder.romanizationFirst,
      );
      await controller.setUseTraditionalLyrics(true);
      await controller.setEmphasizeActiveLyric(false);
      await controller.setRememberPlaybackProgress(true);
      await controller.setAutoSkipPlaybackErrors(true);
      ...
      expect(saved.showTranslation, isFalse);
      expect(saved.showRomanization, isTrue);
      expect(saved.lyricFontSize, LyricFontSize.large);
      expect(saved.lyricAlignment, LyricAlignment.center);
      expect(saved.lyricAuxiliaryOrder, LyricAuxiliaryOrder.romanizationFirst);
      expect(saved.useTraditionalLyrics, isTrue);
      expect(saved.emphasizeActiveLyric, isFalse);
      expect(saved.rememberPlaybackProgress, isTrue);
      expect(saved.autoSkipPlaybackErrors, isTrue);
